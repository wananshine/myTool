  ...
  methods: {
    ...
    handleScroll() {
      let _scrollTop = this.$el.scrollTop,
          ...
          console.log(_scrollTop,_height,_contentHeight,this.height, (_scrollTop / this.height - Math.floor(_scrollTop / this.height)))
      ...
      if (this.lastScrollTop === null || Math.abs(_scrollTop - this.lastScrollTop) > this._max) {
          ...
          console.log('lastScrollTop',this.lastScrollTop, Math.abs(_scrollTop - this.lastScrollTop), this._max)
      } else {
